    ...
    return (
        <form className="credentials-input-wrapper">
            ...
            <div className="semi-black-text-in-credentials">
                ...
                <span className="destination-text-in-credentials">
                    Призначення:
                </span>
            </div>
            ...
            <div className="credentials-regular-transactions-block">
                <div className="credentials-regular-transaction-wrapper">
                    ...
                    <input
                        type="checkbox"
                        name="isRegular"
                        className="is-regular-transaction-true-false"
                    ></input>
                </div>
            ...
            <span className="semi-black-text-in-credentials">ПІП:</span>
            <input name="pib" type="text"></input>
            <span className="semi-black-text-in-credentials">Email:</span>
            ...
            <div className="credentials-text-block-wrapper">
                ...
                <span>
                    IBAN: <b>UA973253210000026002053717183</b> в ЗГРУ ПАТ КБ
                    «ПриватБанку» м.Львів
                </span>
                <div className="horizontal-line-in-credentials"></div>
                <div className="credentials-contact-info-wrapper">
                    <span>
                        Адреса:{' '}
                        <b>79491, Львів-Брюховичі, вул. Бірківська, 11</b>
                    </span>
                    <span>
                        E-mail: <b>itacademyfororphans@gmail.com</b>
                    </span>
                    <span>
                        Skype: <b>ITacademyfororphans</b>
                    </span>
                </div>
                <span>
                    Телефон:{' '}
                    <b>
                        +38 050 750 2555 - Орест Яцкуляк, заступник директора по
