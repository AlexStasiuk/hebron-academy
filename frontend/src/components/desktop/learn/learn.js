        ...
        <div className="content-learn no-gutters">
                ...
                <div className="col-3 txt-learn">
                    ...
                    <div className="text-about-learn">
                        ...
                        <ul className="about-study-learn">
                            ...
                            <li>
                                <span>
                                    Неформальна освіта для молоді з соціально
                                    кризової категорії
                                </span>
                            </li>
                            <li>
                                <span>
                                    Індивідуальна система навчання та підходу
                                </span>
                            </li>
                            <li>
                            ...
                            <li>
                                <span>
                                    Духовний, інтелектуальний та фізичний
                                    розвиток
                                </span>
                            </li>
                            <li>
                                <span>
                                    Забезпечення студентів житлом, харчуванням
                                    та ліками
                                </span>
                            </li>
                            <li>
                ...
                <div className="academy-learn">
                    ...
                    <div className="a-learn">
                        ...
                        <div className="a-p-learn">
                            ...
                            <span>
                                студентам з подальшим працевлаштуванням.
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div className="hh-learn row no-gutters">
                ...
                <div className="h-b-learn col-8">
                    <span>
                        Дана програма включає в себе{' '}
                        <b>духовну, інтелектуальну</b> та <b>фізичну</b>{' '}
                        складову
                    </span>
                    <span>
                        розвитку, а також дає змогу молоді виробити нову систему
                        поведінки
                    </span>
