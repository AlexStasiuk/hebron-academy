...
const Comp5 = { id: 5, img: Comp5Image };
...
const OurGraduatesText = (
    <div>
        <span>
            В перспективі стають не лише кваліфікованими спеціалістами в галузі
            IT, а й
        </span>{' '}
        <b>СВІДОМИМИ</b> <span>та</span> <b>АКТИВНИМИ</b>{' '}
        <span>громадянами сучасного суспільства</span>
    </div>
);
const EducationText = (
    <div>
        <span>
             5 років тому ми задумались, яким чином можна допомогти кризовій
            молоді, в якої є потенціал, але немає можливості успішно
            самореалізуватись у суспільстві, через брак коштів та моральної
            підтримки. І зрозуміли, що найкраща допомога - це{' '}
        </span>
        <b>ОСВІТА</b>
    </div>
);
const PosibilitiesText = (
    <div>
        <span>
            - це молоді люди з числа сиріт та випускників інтернатів, внутрішньо
            переміщені особи, діти учасників воїнів АТО, а також та молодь, яка
            опинилася у складних життєвих обставинах. Це хлопці та дівчата, які
            можуть та хочуть працювати, розвиватися та приносити користь
            суспільству. Все, що їм потрібно, це  дати
        </span>{' '}
        <b>МОЖЛИВІСТЬ</b>
    </div>
);
const CommandText = (
    <div>
        Хеврон ІТ Академія - це спільнота  людей,  яким важлива доля соціально
        незахищеної молоді в Україні. Ми об’єднуємо довкола себе меценатів,
        жертводавців, волонтерів, менторів та просто небайдужих людей! 
    </div>
);
        ...
        <div className="main-page-wrapper">
            <div className="first-block-wrapper row no-gutters">
                ...
                <div className="col-10 second-col">
                    <img
                        src={HebronHeaderImage}
                        alt=""
                        className="hebron-header-image"
                    ></img>
                </div>
                ...
                <div className="col-10 main-header-block-wrapper">
                    ...
                    <div className="main-header-block">
                        ...
                        <div className="header-text">
                            Бути центром інноваційної освіти для сиріт та молоді
                            з групи ризику, побудованої на християнських
                            принципах.
                        </div>
                    </div>
                    <div className="main-header-block">
            ...
            <div className="Ukraine-map-wrapper row no-gutters">
                ...
                <div className="col-4 rel-map-main-p">
                    <br></br>
                    <span className="red-title-on-map">ПІДТРИМКА</span>
                    <span className="title-on-map">
                        Ми хочемо зробити більше!
                    </span>
                    <div className="text-on-map">
                        <span>
                            на сьогоднішній день ми змогли допомогти лише
                            невеликій 
                        </span>
                        <span>
                            кількості молодих людей, але нашої допомоги потребує
                            значно
                        </span>
                        <span>
                            більша кількість талановитих хлопців та дівчат по
                            всій Україні і ми
                        </span>
                        <span>
                            можемо це зробити<b> З ВАШОЮ ПІДТРИМКОЮ!</b>{' '}
                        </span>
                    </div>
                    <br />
                    <button className="btn-on-map">Детальніше</button>
                </div>
            ...
            <HebronInfoImageLeft
                ...
                text={CommandText}
            />
            <MainPageJoinHebron catchClick={catchClickSubmit} isPop={isPopUp} />
