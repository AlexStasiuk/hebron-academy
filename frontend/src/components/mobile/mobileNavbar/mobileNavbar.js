...
const MobileNavbar = () => {
    ...
    const getThreeLinesOrChest = () =>{
        if(isMenuHidden){
            ...
            return(
                <div className='chest-in-mobile-navbar'>
                    X
                </div>
            )
        }
    ...
    const renderMenuPages = () =>{
        return (pagesInfo.map((item, index, array) => {
            ...
            let stripContent = !isLastPage ? <div className='mobile-navbar-menu-page-strip'></div> : null;
            let styleForPageLink = isActivePage ? ' mobile-navbar-menu-active-page': ' mobile-navbar-menu-not-active-page';
            return(
    ...
    return(
        <div className='mobile-navbar-wrapper'>
            <div className='mobile-navbar-logo-and-three-lines-wrapper'>
                <MobileLogoInNavbar/>
                <div className='three-lines-in-navbar-wrapper'
